...
const AboutMe = () => {
  return (
    <div className="grid  w-full items-center gap-[2rem] md:gap-8 min-h-screen">
      <div className="flex flex-col items-start justify-start  xxl:mt-[5rem] xs:mt-[5rem] font-le">
        <motion.p
          initial={{ y: 50 }}
          whileInView={{ y: 0 }}
        ...
        <motion.p
          ...
          viewport={{once: true}}
          className="text-4xl my-4 leading-[3.5rem] lg:text-3xl md:text-2xl sm:text-[20px]"
        >
